...
const updateTimeSlot = catchAsync(async (req: Request, res: Response) => {
  //  inputs user information, object id per day, body to update
...
const deleteTimeSlot = catchAsync(async (req: Request, res: Response) => {
  // console.log("doctorTimeSlot.controller-> deleteTimeSlot-> running");
...
const getAppointmentTimeOfEachDoctor = catchAsync(
